...
import androidx.recyclerview.widget.RecyclerView; // DiffUtil больше не нужен здесь напрямую
...
import ru.yandex.practicum.contacts.presentation.base.BaseListDiffCallback; // Добавлен импорт
...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ViewHolder> {
    ...
    // Старый класс ListDiffCallback удален отсюда
}